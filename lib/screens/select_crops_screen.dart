...
class _SelectCropsScreenState extends State<SelectCropsScreen> {
  ...
  static List<SelectCropModel> mainSelectCropList = [
    SelectCropModel('Apple', 'images/apple.png'),
    ...
    SelectCropModel('Capsicum & Chilli', 'images/capsicum.png'),
    SelectCropModel('Chickpea & Gram', 'images/chickpea.png'),
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: GridView.builder(
                            ...
                            itemCount: displaySelectCropList.length,
                            gridDelegate:
